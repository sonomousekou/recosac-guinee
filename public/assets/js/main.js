 ...
 /*----------------------------------------------
  ...
  $(document).ready(function(){
    ...
    let left_default_amount = $('.left_default_amount').val();
        price_right_parent.find('.total_donation_amount').text(left_default_amount+' GNF');

        $(document).on('click','.selectPricing li',function(){
            let el = $(this).data('amount') + ' GNF' ;
    ...
    $(document).on('keyup','.left_default_amount ',function(){
        let el = $(this).val();
        price_right_parent.find('.total_donation_amount').text(el + 'GNF');
    });
